<template>
  <q-header>
    <span>
      <q-btn dense flat round :icon="ionMenu" @click="$emit('onToggleLeftDrawer')" class="q-mr-xl" />
...
header {
  ...
  @keyframes space-move {
    0% { translate: 0 0; }
    25% { translate: -500px 0; }
    50% { translate: -500px -500px; }
    75% { translate: -1000px -1000px; }
    100% { translate: -500px -500px; }
  }
